...
const List<EngineUiFeature> engineFeatureCatalog = <EngineUiFeature>[
  ...
  // Color grading
  EngineUiFeature(id: 'color.primaryWheels', workspace: EngineWorkspace.color, title: 'Primary Wheels', summary: 'Lift, Gamma, Gain and Offset primary grading.', controls: [EngineUiControl.action('open', 'Open Wheels'), EngineUiControl.action('reset', 'Reset')]),
