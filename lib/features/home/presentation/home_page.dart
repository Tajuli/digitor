...
import 'package:digitor/features/diglog/presentation/diglog_capture_page.dart';
import 'package:digitor/features/projects/presentation/project_library_page.dart';
...
class HomePage extends StatelessWidget {
  ...
  static const List<_HomeAction> _actions = [
    ...
    _HomeAction(
      title: 'DigLog Capture',
      subtitle: 'Capture maximum usable sensor data',
      icon: Icons.videocam_rounded,
      type: _HomeActionType.digLogCapture,
    ),
    _HomeAction(
      title: 'Share Digitor',
    ...
    switch (type) {
      case _HomeActionType.videoEditor:
        await Navigator.of(context).push(
          MaterialPageRoute<void>(builder: (_) => const ProjectLibraryPage()),
        );
        break;
      case _HomeActionType.imageEditor:
        await _pickAndOpenEditor(context, isVideo: false);
        break;
      case _HomeActionType.digLogCapture:
        await Navigator.of(context).push(
          MaterialPageRoute<void>(builder: (_) => const DigLogCapturePage()),
        );
        break;
...
enum _HomeActionType { videoEditor, imageEditor, digLogCapture, shareDigitor }
