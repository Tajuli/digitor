...
class _ColorGradingSheetState extends State<ColorGradingSheet> {
  ...
  void _reset(){
    ...
    else {_replace(node.copyWith(grade:const ClipColorAdjustments(), wheels:const ColorWheelSettings()));}
  }
  ...
  Widget _wheels() {
    ...
    return ListView(
      ...
      children: [
        ...
        _wide('Contrast', grade.contrast, -1, 1, (v) => _grade(grade.copyWith(contrast: v))),
        _wide('Saturation', grade.saturation, -1, 1, (v) => _grade(grade.copyWith(saturation: v))),
        _wide('Temperature', grade.temperature, -1, 1, (v) => _grade(grade.copyWith(temperature: v))),
        _wide('Tint', grade.tint, -1, 1, (v) => _grade(grade.copyWith(tint: v))),
      ],
    );
  }
