...
@override Widget build(BuildContext context) => Column(children: tracks.map((track) => RepaintBoundary(child: TrackRow(track: track, timelineWidth: width, controller: projectController, timelineController: timelineController, pixelsPerSecond: timelineController.pixelsPerSecond, onMoveEnd: onMoveEnd))).toList()); }
