...
class _TimelineCanvasState extends State<TimelineCanvas> {
            ...
            child: Stack(children: [
              ...
              Column(children: [
                GestureDetector(
                  ...
                  onTapDown: (details) => _tapToSeek(details.localPosition.dx),
                  child: TimeRuler(
                    duration: project.duration,
                    pixelsPerSecond: widget.timelineController.pixelsPerSecond,
                    fps: project.fps,
                  ),
                ),
  ...
  void _tapToSeek(double localX) {
    if (_scrubbing) return;
    widget.projectController.clearSelection();
    final position = widget.timelineController.snapPlayhead(
      TimelineMath.pixelsToDuration(
        localX,
        widget.timelineController.pixelsPerSecond,
      ),
    ...
    _seek(position);
    widget.playbackController.scrubTo(position);
  }
