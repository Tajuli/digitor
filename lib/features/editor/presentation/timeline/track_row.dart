...
class TrackRow extends StatelessWidget { const TrackRow({super.key, required this.track, required this.timelineWidth, required this.controller, required this.timelineController, required this.pixelsPerSecond, required this.onMoveEnd}); final TimelineTrack track; final double timelineWidth; final ProjectController controller; final TimelineController timelineController; final double pixelsPerSecond; final void Function(String, String, Duration, Offset) onMoveEnd;
