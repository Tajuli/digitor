...
class _EditorPageState extends State<EditorPage> {
  ...
  Future<void> _openExportSheet() async {
    ...
    // The UI now produces a complete, validated export configuration.
    // Connect this settings object to the native/FFmpeg timeline compositor.
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          '${settings.fileName}.mp4 • ${settings.resolutionLabel} • '
          '${settings.frameRate} fps • ${settings.codecLabel}',
        ),
        action: SnackBarAction(label: 'READY', onPressed: () {}),
      ),
    );
  }
