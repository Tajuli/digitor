...
class _EditorPageState extends State<EditorPage> {
  ...
  void _advanceTransport() {
    ...
    final decoderPosition = _playbackController.position;
    final next = _playbackController.isInitialized && _activeClipId != null
        ? _activeTimelineStart + decoderPosition - _activeSourceStart
        : _timelineController.position + delta;
