  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (_, __) => Column(
        ...
        children: [
          _SubToolbar(tools: tools, project: project, timeline: timeline, onOpenNodes: onOpenNodes, onOpenCorrection: onOpenCorrection, onOpenColorWheels: onOpenColorWheels, onOpenCurves: onOpenCurves, onOpenQualifier: onOpenQualifier),
...
class _SubToolbar extends StatelessWidget {
  ...
  List<Widget> _colorActions(TimelineClip? clip, bool enabled) {
    ...
    return [
      _button('Correction', Icons.tune_rounded, canGrade, onOpenCorrection),
