  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (_, __) => Column(
        ...
        children: [
          _SubToolbar(tools: tools, project: project, timeline: timeline, onOpenNodes: onOpenNodes),
  ...
  List<Widget> _colorActions(TimelineClip? clip, bool enabled) {
    ...
    return [
      ...
      for (final name in [
        ...
        _button(name, Icons.tune, canGrade, () {
          if (clip != null) _nudgeSelectedNode(clip, name);
        }),
