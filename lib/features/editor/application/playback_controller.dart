...
class PlaybackController extends ChangeNotifier {
  ...
  DateTime _lastUiNotification = DateTime.fromMillisecondsSinceEpoch(0);
  ...
  void scrubTo(Duration position) {
    ...
    notifyListeners();
    _seekTimer?.cancel();
    _seekTimer = Timer(const Duration(milliseconds: 90), () => seek(position));
  }
