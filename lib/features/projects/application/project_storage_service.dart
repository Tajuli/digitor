...
class ProjectStorageService {
  ...
  Map<String, dynamic> _clipToJson(TimelineClip clip) => {
        ...
        'volume': clip.volume,
        'muted': clip.muted,
        'colorNodeGraph': clip.colorNodeGraph.toJson(),
        'adjustments': {
          ...
          'hue': clip.colorAdjustments.hue,
          'colorBoost': clip.colorAdjustments.colorBoost,
        },
        'data': clip.data,
      };
  ...
  TimelineClip _clipFromJson(Map<String, dynamic> json) {
    ...
    return TimelineClip(
      ...
      colorNodeGraph: json['colorNodeGraph'] is Map
          ? ColorNodeGraph.fromJson(Map<String, dynamic>.from(json['colorNodeGraph'] as Map))
          : null,
      colorAdjustments: ClipColorAdjustments(
        ...
        hue: (adjustments['hue'] as num?)?.toDouble() ?? 0,
        colorBoost: (adjustments['colorBoost'] as num?)?.toDouble() ?? 0,
      ),
